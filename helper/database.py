...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="@AnimeKurrollu" -metadata author="@AnimeKurrollu" -metadata:s:s title="@AnimeKurrollu" -metadata:s:a title="" -metadata:s:v title="@AnimeKurrollu" """
        )
